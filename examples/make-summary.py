...
def main():
    ...
    lines.append("# 1. 构建（生成 target/influxdb2tsfile-1.0.0.jar）")
    ...
    lines.append("java -jar /Volumes/data/sources/influxdb2tsfile/target/influxdb2tsfile-1.0.0.jar discover \\")
    ...
    lines.append("java -jar /Volumes/data/sources/influxdb2tsfile/target/influxdb2tsfile-1.0.0.jar migrate \\")
    ...
    lines.append("java -jar /Volumes/data/sources/influxdb2tsfile/target/influxdb2tsfile-1.0.0.jar inspect \\")
    ...
    lines.append("java -jar /Volumes/data/sources/influxdb2tsfile/target/influxdb2tsfile-1.0.0.jar lp2tsfile \\")
